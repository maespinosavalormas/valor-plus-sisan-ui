...
export class ConfirmDialogService {
  ...
  confirmCreateCase(): Observable<ConfirmResult> {
  ...
  confirmUpdateCase(): Observable<ConfirmResult> {
    const data: ConfirmDialogData = {
  ...
  confirmDeleteCase(): Observable<ConfirmResult> {
    const data: ConfirmDialogData = {
  ...
  customConfirm(data: ConfirmDialogData): Observable<ConfirmResult> {
    return this.dialog.open(ConfirmDialogComponent, {
      data,
      width: '400px',
      disableClose: true
